...
// Need to split the strings inputed and add them to an array. 
// Count the array.length and return the array length. 

  if (value) {
    // COMPLETE THE LOGIC
    let newArray = value.split(" ") 
    wordCount.innerHTML = `Word Count: ${newArray.length}`; 
  } else {
